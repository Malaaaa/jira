/**
 * Optimistic update of sorting locally
 * @param fromId The id of the item to be sorted
 * @param type 'before' | 'after'
 * @param referenceId reference ID
 * @param list List to sort, tasks, kanbans
 */
export const reorder = ({
  ...
  // Find the subscript of the item corresponding to fromId
...
/**
 * Put from in front of to in the list
 * @param list
 * @param from
 * @param to
 */
